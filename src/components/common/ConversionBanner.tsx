...
const content: Partial<Record<Page, { image: string; eyebrow: string; title: string; text: string; cta: string }>> = {
  ...
  services: { image: 'photo-1723639904882-cb83cb0629e8', eyebrow: 'From scope to handover', title: 'Need a clear plan before you begin?', text: 'We can help you understand the right scope for a 2BHK, 3BHK, villa, office or newly handed-over property.', cta: 'Define Your Project Scope' },
  ...
  journal: { image: 'photo-1600210491892-03d54c0aaf87', eyebrow: 'Turn ideas into a real plan', title: 'Seen something that feels like your home?', text: 'Bring the material, layout or idea you saved to a consultation. We will help you make it work for your own space and routine.', cta: 'Bring an Idea to Life' },
  homes: { image: 'photo-1729108281317-a6c01b07ed92', eyebrow: 'Your home can be next', title: 'Start with your rooms, routines and requirements.', text: 'Whether you are taking possession or renovating, we can translate the way you live into a clear interior plan.', cta: 'Explore an Interior Estimate' },
